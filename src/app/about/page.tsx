      ...
      >
        <motion.section variants={itemVariants} className="text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl text-muted-foreground">
            Empowering students worldwide to find their ideal scholarships
            through AI technology
          </p>
          <Badge
            variant="outline"
            className="mt-4 bg-yellow-100 text-yellow-800"
          >
        ...
        <motion.section
          ...
          className="space-y-4 mt-15 md:mt-30"
        >
        ...
        <motion.section
          variants={itemVariants}
          className="space-y-6 mt-15 md:mt-30"
        >
          <h2 className="text-xl sm:text-2xl font-bold flex items-center gap-2 justify-center">
            ...
            {[
              {
                ...
                content:
                  "Natural language processing for intuitive scholarship discovery",
              },
              {
                title: "Comprehensive Database",
                content: "Thousands of scholarships updated regularly",
              },
              {
                title: "Smart Filters",
                content: "Filter by location, degree level, amount, and more",
              },
              {
                title: "School Insights",
                content:
                  "Detailed university profiles with scholarship information",
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
        ...
        <motion.section
          variants={itemVariants}
          className="space-y-4 text-center mt-15 md:mt-30"
        >
          <h2 className="text-xl sm:text-2xl font-bold flex items-center gap-2 justify-center">
          ...
          <p className="text-base sm:text-lg">
            ScholarSeeker AI is an assessment project built for
            VisaCompanion.ai.
          </p>
