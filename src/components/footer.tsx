    ...
    <footer className="footer">
      <div className="container  py-12 mx-auto">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            <h3 className="text-white dark:text-gray-900 font-semibold">
              Quick Links
            </h3>
            <div className="flex flex-col space-y-3">
              <Link
                href="/search"
                className="text-gray-400 dark:text-gray-600 hover:text-[#6868c7]  dark:hover:text-[#6868c7]"
              >
                Advanced Search
              </Link>
              <Link
        ...
        <div className="border-t border-gray-800 dark:border-gray-300 mt-12 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between text-gray-400 dark:text-gray-600 text-sm">
            <div className="text-center md:text-left">
              © {new Date().getFullYear()} ScholarSeeker AI. All rights
              reserved.
            </div>
          </div>
        </div>
